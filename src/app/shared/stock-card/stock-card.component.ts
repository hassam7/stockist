...
import { StockCardService, StockItem } from 'src/app/services/stock-card.service';
...
export class StockCardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (inputPassed === 'active') data$ = this.stockCard.getActiveStockDetails();
    else if (inputPassed === 'gainer') data$ = this.stockCard.getGainingStockDetails();
    else if (inputPassed === 'loser') data$ = this.stockCard.getLosingStockDetails();
