// @ts-nocheck
import { Component, ElementRef, Input, SimpleChanges, OnChanges, Output, EventEmitter } from '@angular/core';
  ...
  private draw() {
    ...
    svg.append('rect')
      ...
      .on('click', function () {
        ...
        that.dataSelected.emit({ date: d.date, open: d.open, close: d.close, high: d.high, volume: d.volume });
      });
